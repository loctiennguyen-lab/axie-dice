...
# src/client.html carries CSS + all client JS in one file (see the comment at
# its top for why engine/data/devtools/art/cosmetics deliberately stay out).
...
<title>Axie Dice: Lunacia Mutants</title>
...
<meta property="og:title" content="Axie Dice: Lunacia Mutants">
...
<div id="bgLayer"></div>
<div id="app"></div>
<!-- Data + engine first: one shared global scope, no module system, and
...
out='index.html' if PUBLIC else 'AxieDice.html'
