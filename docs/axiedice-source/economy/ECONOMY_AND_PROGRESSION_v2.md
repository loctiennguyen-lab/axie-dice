...
### 1.2 Cần anh duyệt ⬜ — 16 mục

Mỗi dòng: **tôi quyết gì · vì sao · nếu anh bác thì sao**.
...
2. **Không bán chỉ số.** Không part mạnh hơn, không mặt giá trị cao hơn, không gacha cầu sức mạnh.
...
> 🔬 **S3 — Sink đầu cuối chưa có.** Sau 192 part, thang giá hữu hạn hết chỗ tiêu và Shard mất giá trị. Cần sink **lặp lại vô hạn**: reroll cửa hàng trong run, cosmetic mua bằng Shard, vé Gauntlet phụ, hệ prestige đổi Shard lấy điểm Collection Log. **Chốt trước khi ship.**
